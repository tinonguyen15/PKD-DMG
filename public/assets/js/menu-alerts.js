(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      .menu-card{position:relative;overflow:visible}.menu-card[data-alert-level="normal"]{box-shadow:inset 0 0 0 1px rgba(18,183,106,.18)}.menu-card[data-alert-level="soon"]{background:#fffaeb!important;box-shadow:inset 0 0 0 2px #fdb022}.menu-card[data-alert-level="paused"]{background:#fff4e5!important;box-shadow:inset 0 0 0 2px #fb8500}.menu-card[data-alert-level="out"]{background:#fef3f2!important;box-shadow:inset 0 0 0 2px #f04438}
      .menu-alert-tools{display:inline-flex;gap:5px;align-items:center;flex-wrap:wrap;margin-top:5px;max-width:100%}.menu-alert-badge{display:inline-flex;align-items:center;max-width:132px;min-height:21px;padding:2px 7px;border-radius:999px;font-size:10px;font-weight:900;line-height:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.menu-alert-badge.is-hidden{display:none}.menu-alert-badge.soon{background:#fffaeb;color:#b54708}.menu-alert-badge.paused{background:#fff4e5;color:#c25b00}.menu-alert-badge.out{background:#fef3f2;color:#b42318}.menu-alert-btn{display:inline-grid;place-items:center;min-width:28px;width:28px;height:24px;padding:0;border:1px solid #d0d5dd;border-radius:999px;background:#fff;color:#667085;font-size:12px;font-weight:900;cursor:pointer;line-height:1}.menu-alert-btn:hover{border-color:#0f6b48;color:#0f6b48;background:#f5fff8}.menu-alert-btn[title]{font-size:0}.menu-alert-btn[title]::before{content:'⚠';font-size:12px;line-height:1}
      ...
      @media(max-width:700px){.menu-alert-actions{grid-template-columns:1fr}.menu-alert-badge{max-width:112px}.menu-warning-dialog{padding:18px;border-radius:18px}.menu-warning-actions{flex-direction:column-reverse}.menu-warning-actions .btn-secondary,.menu-warning-actions .btn-primary{width:100%}}
    `;
  ...
  function initCards() {
    $$('[data-menu-card]', form).forEach((card) => {
      ...
      tools.innerHTML = '<span class="menu-alert-badge is-hidden" data-menu-alert-badge></span><button class="menu-alert-btn" type="button" data-menu-alert-open title="Bật cảnh báo món" aria-label="Bật cảnh báo món">Cảnh báo</button>';
  ...
  function renderCards() {
    ...
    $$('[data-menu-card]', form).forEach((card) => {
      ...
      if (!branchId || !alert) {
        badge.className = 'menu-alert-badge is-hidden';
        badge.textContent = '';
        badge.title = '';
        return;
      }
